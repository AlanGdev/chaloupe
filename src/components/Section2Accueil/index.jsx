    ...
    <>
      {
        ...
        <section className="w-full md:w-3/5 sm:w-4/5 xs:w-full mx-auto my-8 p-2 rounded-lg bg-transparent">
          ...
          <p className="text-2xl leading-loose text-center">
            ...
            <br />
            &Agrave; La Chaloupe, chaque visite est une invitation &agrave; la
            d&eacute;tente et au plaisir des papilles.
          </p>
        </section>
      }
    </>
